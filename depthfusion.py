...
def mvsnet_to_gipuma(dense_folder, gipuma_point_folder):
    ...
    for image_name in image_names:
        ...
        in_cam_file = os.path.join(depth_folder, image_prefix+'_cam.txt')
    ...
    for image_name in image_names:
        ...
        in_depth_pfm = os.path.join(depth_folder, image_prefix+'.pfm')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dense_folder', type=str, default = '/home/linsc/dataset/dtu/scan1/')
