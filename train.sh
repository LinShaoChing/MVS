...
python train.py --dataset=dtu_yao --batch_size=1 --trainpath=$MVS_TRAINING --trainlist lists/dtu/mini_train.txt --testlist lists/dtu/test.txt --numdepth=160 --logdir ./checkpoints/d192 $@
